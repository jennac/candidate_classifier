...
class SiteData:
    def __init__(self, filename, categories):
        ...
        for l in csv.DictReader(open(filename)):
            self.data.append(l['sitetext'])
            self.target.append(category_dict[l['class']])
...
data_train = SiteData('fb/fbsearch_results_train.csv', categories)
data_test = SiteData('fb/fbsearch_results_test.csv', categories)
"""
